 ...
 * 
 */
@WebServiceClient(name = "SoapExceptionThrowerService", targetNamespace = "http://system.services.server.exampleproject.soapworks.optimaize.com/", wsdlLocation = "http://localhost:80/soap/v1/system/exceptionthrower?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPEXCEPTIONTHROWERSERVICE_QNAME = new QName("http://system.services.server.exampleproject.soapworks.optimaize.com/", "SoapExceptionThrowerService");
    ...
    public SoapExceptionThrower getSoapExceptionThrowerPort() {
        return super.getPort(new QName("http://system.services.server.exampleproject.soapworks.optimaize.com/", "SoapExceptionThrowerPort"), SoapExceptionThrower.class);
    }
    ...
    public SoapExceptionThrower getSoapExceptionThrowerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://system.services.server.exampleproject.soapworks.optimaize.com/", "SoapExceptionThrowerPort"), SoapExceptionThrower.class, features);
    }
