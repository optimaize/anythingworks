...
import com.optimaize.anythingworks.server.rest.JsonErrorEnvelope;
 ...
 */
public class JsonErrorRestExceptionMapper implements javax.ws.rs.ext.ExceptionMapper<Exception> {
    ...
    private Object wrapEnvelope(JsonError jsonError) {
        return JsonErrorEnvelope.error(jsonError);
    }
